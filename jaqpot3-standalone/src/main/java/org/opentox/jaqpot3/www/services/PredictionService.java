...
import org.opentox.jaqpot3.qsar.util.GenericUtils;
    ...
    public void run() {
        ...
        try {
            ...
            if(StringUtils.equals(debug, "true")) {
                ...
                predictor.getTask().setHttpStatus(200).setResultUri(datasetURI).setPercentageCompleted(100.0f).setStatus(Status.COMPLETED);
