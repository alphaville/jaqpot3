-- 
-- DATABASE VERSION : 2.2.5
--
DROP DATABASE IF EXISTS `toxotisdb`;
CREATE DATABASE `toxotisdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin;
USE `toxotisdb`;
--
-- Version
--
...
INSERT INTO `Version` (`First`,`Second`,`Third`) VALUES (2,2,5); 
UNLOCK TABLE ;
--
...
CREATE TABLE `Parameter` (
  ...
  CONSTRAINT `id_of_prm_references_otcomponent` FOREIGN KEY (`id`) REFERENCES 
    `OTComponent` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
--
-- Error Repots
--
